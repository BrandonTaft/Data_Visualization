            ...
            return (
                <>
                    <ul className="explanation-list">
                        ...
                        <li>Then the for loop starts over with the next element in the <span className="bg-purple">unsorted array</span> and repeats the process.</li>
                        <li>Once the for loop has gone through the whole <span className="bg-purple">unsorted array</span>, the <span className="bg-orange">sorted array</span> is returned.</li>
                    </ul>
                </>
            )
            ...
            return (
                <>
                    <ul className="explanation-list">
                        ...
                        <li> <span className="bg-green">min</span> will keep track of the index with the lowest value and will start out as the same index as <span className="bg-blue">arr[i].</span></li>
                        <li> All elements to the right of <span className="bg-blue">arr[i]</span> make up the <span className="bg-purple">unsorted array.</span></li>
                        <li> The nested loop compares each element in the <span className="bg-purple">unsorted array</span> to the value of <span className="bg-green">arr[min].</span></li>
                        <li> If its value is lower than <span className="bg-green">arr[min]</span> then its index will now be set to <span className="bg-green">min.</span></li>
                        <li> When each pass of the nested for loop is finished, <span className="bg-green">arr[min]</span> will be the lowest value in the <span className="bg-purple">unsorted array.</span></li>
                        <li> Then <span className="bg-green">arr[min]</span> is added to the end of the <span className="bg-orange">sorted array</span> by swapping places with <span className="bg-blue">arr[i].</span></li>
            ...
            return (
                <>
                    <ul className="explanation-list">
                        ...
                        <li>Inside the Partition function, the value in the last index will always be the <span className="bg-blue">pivotValue</span> and the <span className="bg-orange">pivotIndex</span> will start as the first index and move right one spot for every element that is less than the <span className="bg-blue">pivotValue.</span></li>
