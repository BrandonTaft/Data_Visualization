        ...
        case "bubble":
            return (
                <div className='card-content'>
                    ...
                    <p className="content-description">Bubble sort is simple, effective, and a good place to start learning.
                        Although the number of swaps are equal to the number of inversion pairs in the array, making it not suitable for large data sets.
                        </p>
