...
export function BubbleCardContent() {
    return (
        <CardContent className='dark card-content'>
            <span className="content-header">Bubble Sort</span>
            <p className="dark content-description">While its not suitable for large data sets the bubble sort algorithm is a reliable sorting algorithm.
...
export function InsertionCardContent() {
    return (
        <CardContent className='dark card-content'>
            ...
            <p className="dark content-description">Insertion Sort is arguably the most intuitive sorting algorithm. It sorts exactly like you would when drawing cards from the top of a deck.
...
export function SelectionCardContent() {
    return (
        <CardContent className='dark card-content'>
            ...
            <p className="dark content-description"> Despite Selection Sort's inefficiency with large data sets, it works well with small lists.
...
export function QuickCardContent() {
    return (
        <CardContent className='dark card-content'>
            ...
            <p className="dark content-description"> Even though Selection Sort is inefficient with large data sets, it works well with small lists and is another great place to start learning.
